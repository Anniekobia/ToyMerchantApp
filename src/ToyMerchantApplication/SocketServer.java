...
//        serverRequests.add("Send Toy Code and Name");
        ...
        try{
            ...
            while(!msgin.equals("exit") && i < serverRequests.size()){
                ...
                //showMessage("Send toy code and toy name\n");
            ...
            //showMessage("\n Communication was successful! Here are your toy details:\n");
...
//        private void editable(final boolean trueOrFalse){
//        SwingUtilities.invokeLater(
//                new Runnable(){
//         private void editable(final boolean trueOrFalse){
//                   public void run(){
//                        msg_text.setEditable(trueOrFalse);
//                    }
//                }
//        );
//    }
